...
public class VotingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigation.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_home) {
                ...
                startActivity(new Intent(VotingActivity.this, CandidatesActivity.class));
                finish();
                return true;
                ...
                startActivity(new Intent(VotingActivity.this, AnnouncementsActivity.class));
                finish();
                return true;
    ...
    private void navigateBackToDashboard() {
        Intent i = new Intent(VotingActivity.this, DashboardActivity.class);
